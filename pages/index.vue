        ...
        <div class="home-elem-198">
            <div class="home-elem-197">
                <div class="home-elem-186"> <span class="home-elem-173">
                        <p><strong>Көмек керек пе жок? Хабарлама жіберу формасын пайдаланыңыз</strong></p>
        ...
        <div class="home-elem-74">
            <div class="home-elem-63">
                <div class="home-elem-62"> <span class="home-elem-60">
                        <p>Объектіге бағытталған бағдарламалау (ОББ) </p>
                    </span><span class="home-elem-61">
                        <p> Бұл бағдарламалық жасақтаманы әзірлеу тәсілі, яғни, бағдарламалаудың идеясын білдіреді. ОББ бағдарламада өзара әрекеттесетін объектілердің жиынтығы ретінде ұсынылады. Олардың әрқайсысының өзіндік деректері мен функционалдық мүмкіндіктері бар. Обб компьютерлік бағдарламаны функциялар жиынтығының дәйекті орындалуы ретінде қарастырады. . </p>
            ...
            <div class="home-elem-68"> <span class="home-elem-64"> <img src="https://res.cloudinary.com/storylens/image/upload/v1698486909/mefviy2hmtqmzy2bqsaq.jpg"> </span>
                <div class="home-elem-67"> <span class="home-elem-65">
                        <p>Негізгі ұғымдары </p>
                    </span><span class="home-elem-66">
                        <p>Объектіге бағытталған бағдарламалау негізгі ұғымдары болып сыныптар мен объектілер саналады.
                            <br>- Сынып – бұл объектілердің атрибуттары мен мінез-құлқын, қасиеттерін сипаттайды.
                            <br>- Объект – бұл өзіндік ерекше қасиет мәндеріне ие бола алатын және аттрибуттарының дәл мәндері бар сынып данасы.
                            .
                        </p>
            ...
            <div class="home-elem-73">
                <div class="home-elem-72"> <span class="home-elem-70">
                        ...
                        <p>Объектіге бағытталған бағдарламалау өзіндік жеке принциптер арқылы бағдарламалауда тапсырмаларды шешеді және жұмыс жасайды.
                            Олар:
                            <br>- Мұрагерлік – бұл бір сынып екінші сыныптың қасиеттері мен әдістерін мұра етіп алуы, яғни, кодты қайта-қайта пайдалану мүмкіндігі.
                            <br>- Инкапсуляция – бұл іске асырылатын мәліметтерді басқа сыртқы кодтардан жасырып, қасиеттер мен әдістерді бір сынып ішінде біріктіру мүмкіндігі.
                            <br>- Полиморфизм – бұл әртүрлі объектілерді пайдалану мен кеңейту, яғни, әртүрлі объектілермен жұмыс жасау үшін бірдей кодты пайдалану мүмкіндігі.
                            .
                        </p>
                    ...
                    </button></div><span class="home-elem-69">
                    <img src="~/assets/images/programming.jpeg" alt="">
                </span>
            </div>
            <div class="home-elem-68"> <span class="home-elem-64"> 
            <img src="~/assets/images/programming2.jpeg" alt="">
             </span>
                <div class="home-elem-67"> <span class="home-elem-65">
                    <p>Негізгі артықшылықтары </p>
                </span><span class="home-elem-66">
                    <p>Объектіге бағытталған бағдарламалау негізгі артықшылықтары мен тиімді тұстары:
<br>-	Бағдарламаны жеке сыныптарға бөлу арқылы кодты түсінуді және өзгерістер енгізуді жеңілдетуі;
<br>-	Сыныптар мен объектілерді бағдарламаның басқа бөліктерінде қайта пайдалану арқылы даму уақыты мен ресурстарды үнемдей алуы;
<br>-	Әр сынып тек жеке міндеттеріне ғана жауап беріп, бағдарламаны жөндеу мен қолдауды жеңілдетуі;
<br>-	Жаңа мүмкіндіктері бар сыныптарды келесі сыныптарға мұра ету арқылы қосуы;
<br>-	Объектілер мен объектілер арасындағы қатынастарды модельдеуге мүмкіндік беруі.
